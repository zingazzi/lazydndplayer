// internal/ui/state/state_machine_test.go
package state
...
func TestTransition(t *testing.T) {
	...
	sm.Transition(StateFeatSelection, nil)

	if sm.GetState() != StateFeatSelection {
...
func TestTransitionWithContext(t *testing.T) {
	...
	sm.Transition(StateFeatSelection, context)
...
func TestClear(t *testing.T) {
	...
	sm.Transition(StateFeatSelection, map[string]interface{}{
		"key1": "value1",
		"key2": "value2",
	})
