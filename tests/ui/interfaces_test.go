...
func TestStorageInterface(t *testing.T) {
	...
	var _ ui.StorageInterface = (*mockStorage)(nil)
...
func TestComponentFactoryInterface(t *testing.T) {
	...
	var _ ui.ComponentFactoryInterface = (*ui.ComponentFactory)(nil)

	factory := ui.NewComponentFactory()
